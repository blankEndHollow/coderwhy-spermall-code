...
<div class="miansids">
    <div class="cateLeft">
      ...
      <div class="cateRight">
      <tab-control ref="upTab" v-show="doFoc" class="upTap" @tabClick="topCo" :titles="['流行','新款','精选']" />
        <scroll class="content" :probe-type="3" @scroll="slide"  ref="scrollTo">
          <pattem @loadImage="scrollRefresh" @together="topCo" :display="main" ref="pattem" />
        </scroll>
      </div>
    </div>
...
export default {
  ...
  methods:{
    ...
    topCo(n){
      this.$refs['pattem'].three(n)
      this.$refs['upTab'].currentIndex=n
    } 
  },
  components:{
    Scroll,
